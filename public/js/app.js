...
/* harmony import */ var _auth_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth.js */ "./resources/js/store/auth.js");
...
function getCookieValue(searchKey) {
  ...
  var val = '';
  document.cookie.split(';').foeEach(function (cookie) {
